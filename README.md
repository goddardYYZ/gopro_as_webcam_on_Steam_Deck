[![goddard - YYZ](https://img.shields.io/badge/goddard-YYZ-2ea44f)](https://)	[![GitHub release](https://img.shields.io/github/release/goddardYYZ/gopro_as_webcam_on_Steam_Deck?include_prereleases=&sort=semver&color=blue)](https://github.com/goddardYYZ/gopro_as_webcam_on_Steam_Deck/releases/) ![](https://img.shields.io/github/last-commit/goddardYYZ/gopro_as_webcam_on_Steam_Deck) [![OS - Linux](https://img.shields.io/badge/OS-Linux-blue?logo=linux&logoColor=white)](https://www.linux.org/ "Go to Linux homepage") [![Made with Bash](https://img.shields.io/badge/Bash->=3-blue?logo=gnu-bash&logoColor=white)](https://www.gnu.org/software/bash/ "Go to Bash homepage") [![HitCount](http://hits.dwyl.com/goddardYYZ/gopro_as_webcam_on_Steam_Deck.svg)](http://hits.dwyl.com/goddardYYZ/gopro_as_webcam_on_Steam_Deck)
